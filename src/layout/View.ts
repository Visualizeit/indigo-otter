...
import  {
	...
	type KeyUpHandler,
	type LayoutHandler,
	type MouseClickHandler,
	type MouseDownHandler,
	type MouseEnterHandler,
	type MouseEvent,
	type MouseLeaveHandler,
	type MouseMoveHandler,
	type MouseUpHandler,
	type ScrollEvent,
	type ScrollHandler, UserEventType 
} from './eventTypes'
import  { type ViewStyleProps, Overflow  } from './styling'
...
export class View extends BaseView {
	...
	constructor(
		...
		this.handleMouseMoveScrollHovering =
			this.handleMouseMoveScrollHovering.bind(this)
		...
		if (
			this._style.overflowX === Overflow.Scroll ||
			this._style.overflowY === Overflow.Scroll
		) {
